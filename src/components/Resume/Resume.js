...
import pdf from '../../Assets/Saurav_SDE_Resume.pdf'
      ...
      <Container>
        ...
        <Row className="resume">
          <Col md={6} className="resume-left">
            ...
            <Resumecontent
              title="Full Stack Web developer [Antaragni]"
            ...
            />
            <Resumecontent
              title="Android developer [Udghosh]"
          ...
          <Col md={6} className="resume-right">
            ...
            <Resumecontent
              title="Civil Engineering [ I.I.T KANPUR ] "
              date="2021 - 2025"
              content={[
                `CGPA: 9.00/10 `,
                'I am pursuing my bachelor degree fron Indian Institute of Technology Kanpur.',
              ]}
            />
